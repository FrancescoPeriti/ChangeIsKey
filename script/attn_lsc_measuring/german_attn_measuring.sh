...
attention_folder="$1/LSC/SemEval-German"
dataset_folder="$2/LSC/SemEval-German"
tokenization_folder="$3/LSC/SemEval-German"
attn_score_folder="$4/LSC/SemEval-German"

layers=12

declare -a models=("bert-base-german-cased" "bert-base-multilingual-cased")
